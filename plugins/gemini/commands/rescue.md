...
argument-hint: "[--background|--wait] [--resume|--fresh] [--write] [--model <gemini-2.5-pro|gemini-2.5-flash>] [what Gemini should investigate, solve, or continue]"
...
The final user-visible response must be the gemini-rescue subagent's output verbatim.
